...
# Guardar gráfico
ggsave(filename="Municipios_poseen_area.png", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/PNG/"),
       plot=grafico, dpi=100, width=9, height=7)
ggsave(filename="Municipios_poseen_area.svg", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/SVG/"),
