...
Data <- data.frame(Genero = factor(c("Mujeres cis", "Varones cis"),
...
# Guardar gráfico
ggsave(filename="Senadores_genero.png", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/PNG/"),
       plot=grafico, dpi=100, width=7, height=5)
ggsave(filename="Senadores_genero.svg", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/SVG/"),
