...
Raw <- data.frame(Caratula = factor(c("Tienen la carátula provisoria de femicidio", "Se encuentran en etapa de investigación"),
                                    levels=c("Tienen la carátula provisoria de femicidio", "Se encuentran en etapa de investigación")),
                  Cantidad = c(12, 23))
