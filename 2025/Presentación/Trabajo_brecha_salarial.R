...
grafico <- ggplot(Data, aes(x=Jerarquia, y=Valor)) +
  geom_segment(data=Lineas, aes(x=Jerarquia, xend=Jerarquia, y=ymin, yend=ymax), color="grey50", linewidth=1.5) +
  ...
  theme(text=element_text(family="font_sans"),
        ...
        panel.grid.major.y = element_line(linewidth = 0.5, color="grey75"),
        panel.border = element_blank(),
        axis.ticks = element_blank(),
        axis.text.x = element_text(size=15, family="font_sans", margin = margin(t=10,r=0,b=5,l=0)),
