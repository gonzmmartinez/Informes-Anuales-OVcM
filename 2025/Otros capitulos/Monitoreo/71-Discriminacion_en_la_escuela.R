...
grafico <- ggplot(Data, aes(ymax=ymax, ymin=ymin, xmax=4, xmin=2.5, fill=Categoria)) +
  ...
  coord_polar(theta="y") +
  labs(title=str_wrap("¿Alguna vez presenció una situación de discriminación o violencia en la escuela por cuestiones de identidad de género, expresión de género u orientación sexual?",
                      width=60),
       subtitle="Docentes y personal administrativo, n = 27") +
  xlim(c(1.5, 4.5)) +
  theme_void() +
