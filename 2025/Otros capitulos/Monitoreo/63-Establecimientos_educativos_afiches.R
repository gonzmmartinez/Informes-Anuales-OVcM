...
grafico <- ggplot(Data, aes(ymax=ymax, ymin=ymin, xmax=4, xmin=2.5, fill=Categoria)) +
  ...
  coord_polar(theta="y") +
  labs(title=str_wrap("¿Se colocaron los afiches de la Campaña de difusión de los derechos vinculados a la identidad de género en los espacios educativos en su institución?",
                      width=60),
